...
|                                                                                                                         |                                                                                                                |
| ----------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| [Sidebar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/intervention.html) | [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/config.html) |
...
![images/ref/supervision/interventions.png](.gitbook/assets/interventions.png)
...
The table in section (3) shows, in the right-hand section, all interventions selected during the configuration (appointments and unavailabilities) with any additional options selected in terms of time items (journey times and free time).\
For each item of information, the number of interventions or unavailabilities is calculated, and the time expressed in hours and minutes is displayed. For each type of intervention, the percentage is calculated in relation to the number and the time. The sum of the respective percentages of appointments and unavailabilities adds up to 100%. The two additional options handling time (journey times and free time) are handled in a separate table. A distinction is made between the journey time spent on the appointments fulfilled, and those that have been confirmed, and are expected to be fulfilled. The time is expressed in hours and minutes in relation to the kilometers covered as a function of the road network. The free time completes this series to make the figure up to 100%.
