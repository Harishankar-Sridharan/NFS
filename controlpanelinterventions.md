...
|  |  |
| --- | --- |
| [Sidebar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/intervention.html# "Hide TOC tree") | [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/config.html) | [Up](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/module-supervision.html) | [Next](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/resume-jour.html) |

### control panel - Interventions

#### Role

This page shows a summary table of different interventions [configured](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/config.html "Control panel - Configure") previously.
...
![images/ref/supervision/interventions.png](./images/interventions.png)
...
Section (2) summarises the series of parameters specified in the [configuration](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/config.html "Control panel - Configure") step.

The table in section (3) shows, in the right-hand section, all interventions selected during the configuration (appointments
and unavailabilities) with any additional options selected in terms of time items (journey times and free time).  
For each item of information, the number of interventions or unavailabilities is calculated, and the time expressed in hours
and minutes is displayed. For each type of intervention, the percentage is calculated in relation to the number and the time.
The sum of the respective percentages of appointments and unavailabilities adds up to 100%.
The two additional options handling time (journey times and free time) are handled in a separate table. A distinction is made
between the journey time spent on the appointments fulfilled, and those that have been confirmed, and are expected to be fulfilled.
The time is expressed in hours and minutes in relation to the kilometers covered as a function of the road network. The free
time completes this series to make the figure up to 100%.

The item labelled (4) allows the user to browse interventions according to several criteria, and to choose whether to look
at the detail or not. Select first the type of display required:
...
Next, you can display statistical indicators for each type of display. To obtain detailed indicators, it will be necesssary
to check the **Detail by** check-box, and then select the type of detail required:
...
Click on the ![images/ref/buttons/recyclage.png](./images/recyclage.png) button to update the table (3).

The hierarchical tree presents all the resources form the reference area, organised by team. Clicking on each «entity», it
is possible to update the corresponding table (3). This hierarchical tree rolls out and rolls up.
...
|  |  |  |
| --- | --- | --- |
| [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/config.html) | [Up](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/module-supervision.html) | [Next](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/resume-jour.html) |
...
[Search Highlighter (On/Off)](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/intervention.html#)
