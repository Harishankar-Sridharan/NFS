...
|  |  |
| --- | --- |
| [Sidebar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-carte.html# "Hide TOC tree") | [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/_the_header_bar.html) | [Up](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/module-planification.html) | [Next](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-cadre-info.html) |

### Map

The map is situated in a frame reserved for this purpose at the top right of the Planning module screen.
By default, this will be a background picture of a route from the Here geographic database.
...
![images/ref/planification/carte-route.png](./images/carte-route.png)

#### Navigation

Take up a position on the map, and the mouse cursor changes into a hand that can be used to move around the map.
The user can also zoom-in or zoom-out in the map using the sliding cursor at the left-hand side of the map, or again, using
the mouse wheel.

Finally, a scale at the bottom left-hand side of the frame enables the user to appreciate the orders of magnitude for the
current map.

#### Display

Above the map is a series of buttons enabling activation (link Activate map) or de-activation (link De-activate map) of the map.

The cartographic frame offers the option to display information on the map with the help of the Configuration function. All the information displayed take into account any [perimeter](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/donnees.html#RH-perimetre "Perimeter tab") defined for the user.
...
![images/ref/planification/configuration-carte.png](./images/configuration-carte.png)

**Display the appointments**

Checking the **Display the appointments** check-box, it will be possible to display the appointments on the map. These appear in the form of points, coloured according
to the [legend](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#agenda-legende "Display the legend").

When you click on an appointment in the map, the following tool-tip displays:

Appointment tool-tip

![images/ref/planification/tool-tip-carte-rdv.png](./images/tool-tip-carte-rdv.png)

The Display button displays the [appointment form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-rdv "Appointment form").
...
The Search around button [searches on objects nearby](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#rechercher-environs "Search around") the appointment.

**Display the sectors**

Checking **Display the sectors**, the locations for the [sectors](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/donnees.html#secteur "Sector (or Intervention sector)") display on the map.

|  |  |
| --- | --- |
| [Warning] | Warning |
| For the display to function, you must have saved the towns in the form of at least one [sector](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/donnees.html#secteur "Sector (or Intervention sector)"). |

**Display the customers**

Checking **Display the customers**, the locations of the [customers](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#objets-clients "Customers") display on the map.

Clicking on a customer in the map, the user can display the following tool-tip:

Customers tool-tip

![images/ref/planification/tool-tip-carte-client.png](./images/tool-tip-carte-client.png)

The Display button displays the [customer form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-client "Customer form").

The Add to customers panel button allows you to add the customer to the [panel](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#panier-des-clients "Customers panel").

The Search around button enables a [search on objects nearby](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#rechercher-environs "Search around") the customer.
...
|  |  |  |
| --- | --- | --- |
| [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/_the_header_bar.html) | [Up](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/module-planification.html) | [Next](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-cadre-info.html) |
|  | [Home](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/index.html) |  |

- [Contents](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-carte.html#treeDiv)
- [Search](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-carte.html#searchDiv)
...
[Search Highlighter (On/Off)](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-carte.html#)
