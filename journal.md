...
|                                                                                                                    |                                                                                                                             |
| ------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------- |
| [Sidebar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/journal.html) | [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/supervision-accueil.html) |
...
![images/ref/supervision/journal-config.png](.gitbook/assets/journal-config.png)
...
* _Appointment planned_ : action of confirming an appointment (manual or automated);
...
* _Appointment cancelled by the client_: action of cancelling an appointment by the client;
...
![images/ref/supervision/journal-list.png](.gitbook/assets/journal-list.png)
...
![images/ref/supervision/journal-log.png](.gitbook/assets/journal-log.png)

This table displays data associated to the event under a heading of "New data".\
The "Old data" column is filled only in the case where the event has changed status (example: a planned appointment that has been fulfilled, or again an unavailability that has been cancelled).\
