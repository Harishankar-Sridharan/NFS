...
|                                                                                                                                   |                                                                                                                 |
| --------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| [Sidebar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/bandeau-changer-region.html) | [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/bandeau.html) |
...
![images/ref/intro/changer-region-1.png](.gitbook/assets/changer-region-1.png)
...
![images/ref/intro/changer-region-2.png](.gitbook/assets/changer-region-2.png)

* If you want to change the area in order to find an appointment located in a different area to the current one, check the **Advanced settings** check-box. You will then have the option to change the area by supplying a reference or customer name, an appointment, or a reference for a resource.

Advanced choices

![images/ref/intro/changer-region-avance.png](.gitbook/assets/changer-region-avance.png)
