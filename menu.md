...
[![ Documentation](./images/logo_geoconcept_4.png)](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/index.html)

# Opti-Time Reference Guide Planning

|  |  |
| --- | --- |
| [Sidebar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html# "Hide TOC tree") | [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-cadre-info.html) | [Up](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/module-planification.html) | [Next](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html) |

### Menu

The menu of the Planning module is run via the ![images/ref/buttons/bouton-menu-inactif.png](./images/bouton-menu-inactif.png) button located at the top left of the screen.
By default, the button is inactive and the menu is therefore hidden. To display it, simply move the mouse over it. The button
changes colour ![images/ref/buttons/bouton-menu-actif.png](./images/bouton-menu-actif.png) and the user can consult the menu functions.

|  |  |
| --- | --- |
| [Note] | Note |
| Functions can be displayed or hidden by [rights](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/utilisateurs.html#coll-droits "Collection of rights"). In this way, the number of items present in the menu may vary depending on the current user profile. |

The menu functions are as follows:

- [Change area](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#changer-region "Change area")
- [Set new appointment](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#prendre-nouveau-rdv "Making a new appointment")
- [Customers](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#menu-clients "Customers")

  - [Search for customers](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#menu-clients-rechercher "Customer search")
  - [Create customer](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#menu-clients-creation "Create customer")
  - [Customers panel](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#panier-des-clients "Customers panel")
  ...
  - [Generate periodic requests](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#generer-clients-recurr "Generate periodic requests")
- [Resources management](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#gestion-intervenants "Managing resources")

  - [Temporary job management](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#gestion-postes-temp "Handling of temporary posts")
  - [Secondary worksites assignments management](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#affectation-sites-second "Assignment of secondary worksites")
  - [Display customers](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#visualiser-clients "View customers")
  - [On-call duty management](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#gestion-astreintes "On-call duty management")
  - [Equipment assignments](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#affectation-materiel "Equipment assignments")
- [Sector management](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#gestion-secteurs "Sector management")
- [Appointment search](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#rechercher-rdv "Searching for an appointment")
- [Selected appointment list](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#lister-rdv-select "List selected appointments")
- Requested, planned, reserved, confirmed, unplanned, externalized [appointments](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#chercher-rdv-etats "Search for appointments (requested, planned, reserved, confirmed, unplanned, subcontracted)")
- [My searches](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#mysearch "My searches")
- [Links between interventions](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#liaison-intervention "Links between interventions")
...
- [Customer gap](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#ecart-client "Customer gap")
- [Alerts on route duration](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#alertes-duree-trajet "Alerts on route duration")
- [Application alerts](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#alertes "Application warning messages")
- [Messaging service](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#messages "Messaging service")
- [Modify appointments in the past](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#modifier-rdv-passe "Modify the appointments of the past")
- [Display planners](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#afficher-agendas "Display agendas")
- [Unavailabilities](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#gerer-indispos "Handling unavailabilities")
- [Unavailability search](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#rechercher-indispo "Unavailability search")
...
- [Hotel locations](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#emplacement-hotel "Hotel locations")
...
- [Manage agenda markers](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#gerer-jalons "Manage agenda markers")
- [Vehicles tracking](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#suivi-vehicule "Vehicles tracking")
...
- [Convert coordinates into Lat/Lon](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#convertir-lat-lon "Convert coordinates into Lat/Lon")
- [Search around](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#rechercher-environs "Search around")
...
- [Predefined exports list](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#liste-exports-predef "Predefined exports list")
- [Custom reports](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#liste-rapports-predef "Custom reports")

#### Change area

This function returns you to the [change area](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/bandeau-changer-region.html "Change area") function in the header bar.
...
![images/ref/planification/prendre-rdv-ecran-1.png](./images/prendre-rdv-ecran-1.png)
...
The validation of the address is described in the [geocoding](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/intro-geocodage.html "The geocoding") chapter.

The Cancel button cancels the taking of the appointment.

The Continue button takes you to the [qualification of the appointment](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#creation-rdv-demande "Qualification of the appointment") window.
...
In some companies, it is current practice to carry out maintenance visits or sales rounds for [customers](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#objets-clients "Customers") who are already known to the company.
It can even happen that certain technicians are assigned by default to certain [customers](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#objets-clients "Customers").
In order to avoid entering information that is already known about [customers](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#objets-clients "Customers"), the application suggests saving a [customer](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#objets-clients "Customers") database to facilitate the taking of appointments.

The Customers menu presents the following options:

- [**Customer search**](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#menu-clients-rechercher "Customer search")
- [**Create customer**](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#menu-clients-creation "Create customer")
- [**Customers panel**](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#panier-des-clients "Customers panel")
- [**Customer alerts list**](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html)
- [**Generate periodic requests**](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#generer-clients-recurr "Generate periodic requests")
...
The principle of the search functions is described in the [Search in the Planning module](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-recherche "Search in the Planning module") chapter.

The search fields are described in the [customer form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-client "Customer form").

This page allows you to [create](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-creer "Create an object in the Planning module") or modify a customer.

In the page header, depending on the configuration, a series of links serve to:

- [Show Customers panel](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#panier-des-clients "Customers panel")
- [Orderer search](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#rechercher-commanditaire "Searching for the company orderer")
- [Customer type search](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#rechercher-type-client "Search on a customer type")
- [Customer kind search](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#rechercher-nature-client "Search on customer kind")

**Result of the search**

Table of results

![images/ref/planification/resultat-recherche-client.png](./images/resultat-recherche-client.png)
...
| --- | --- |
| [Tip] | Tip |
| The display limit is [configurable](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/perso.html#config-appli "Application settings"). |

The table has the same [basic functionalities](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-recherche "Search in the Planning module") as the other tables in Opti-Time.
...
The presence of buttons on each line in the table serves to apply certain actions without having to enter in the customer
form. Here are a few of the possible actions:

- The ![images/ref/buttons/bouton-panier4.png](./images/bouton-panier4.png) button allows you to add the customer to the panel;
- The ![images/ref/buttons/bouton-prendre-rdv.png](./images/bouton-prendre-rdv.png) button serves to make an appointment with the customer, at which point you are redirected to the [qualification of the appointment](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#creation-rdv-demande "Qualification of the appointment") page;
- The ![images/ref/buttons/bouton-localise-client-fiche.png](./images/bouton-localise-client-fiche.png) button localises the customer on the [map](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-carte.html "Map");
- The ![images/ref/buttons/bouton-lister-rdv-client.png](./images/bouton-lister-rdv-client.png) button lists all the appointments for the customer;
...
![images/ref/planification/liste-rdv-client.png](./images/liste-rdv-client.png)

+
The first part allows you to [refine the search](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#recherche-generique-filtre "Search filters").
...
+
Finally, the list of appointments allows you to display the [appointment form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-rdv "Appointment form") by clicking on one line of the [result](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-resultat "Search result").

To display the [customer form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-client "Customer form"), click on the corresponding line in the table of results.

##### Searching for the company orderer

This function allows you to [create](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-creer "Create an object in the Planning module"), modify, or delete an orderer ([see the customer form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#type-client-fiche "Customer type form")).

Purchasing orderer search window

![images/ref/planification/formulaire-recherche-commanditaire.png](./images/formulaire-recherche-commanditaire.png)

The principle of the search functions is described in the [Search in the Planning module](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-recherche "Search in the Planning module") chapter.

The search fields are described in the [orderer form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-commanditaire "Orderer form").

Click on the [orderer](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#commanditaire "Orderers") in the list to go back to the corresponding [form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-commanditaire "Orderer form").

The ![images/ref/buttons/bouton-ajouter.png](./images/bouton-ajouter.png) button returns you to the [orderer form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-commanditaire "Orderer form") in creation mode.

##### Search on a customer type

This function allows you to search, [create](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-creer "Create an object in the Planning module") or change a customer type.

Searching on customer types

![images/ref/planification/page-recherche-type-client.png](./images/page-recherche-type-client.png)

The principle of the search functions is described in the [Search in the Planning module](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-recherche "Search in the Planning module") chapter.

The search fields are described in the [customer type form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#type-client-fiche "Customer type form").

The ![images/ref/buttons/bouton-ajouter.png](./images/bouton-ajouter_2.png) button allows you to add a new customer type. This returns you to the [customer type form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#type-client-fiche "Customer type form") in creation mode.

##### Search on customer kind

This function allows you to search, [create](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-creer "Create an object in the Planning module") or change a customer according to its kind.

Search on customer kind

![images/ref/planification/page-recherche-nature-client.png](./images/page-recherche-nature-client.png)

The principle of the search functions is described in the [Search in the Planning module](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-recherche "Search in the Planning module") chapter.

The search fields are described in the [customer kind form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#nature-client-fiche "Customer kind form").

The ![images/ref/buttons/bouton-ajouter.png](./images/bouton-ajouter_3.png) button serves to add a new customer kind. This takes you back to the [customer kind form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#nature-client-fiche "Customer kind form") in creation mode.

##### Create customer

This page allows you to [create](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-client "Customer form") a customer.
...
![images/ref/planification/panier-clients.png](./images/panier-clients.png)

The [search result](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-resultat "Search result") presents the customers in the panel.

Clicking on a line, you can access the [customer form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-client "Customer form").

- The Customer search link takes you back to the [customer search](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#menu-clients-rechercher "Customer search") function;
- The Empty panel link removes the appointments from the customer panel;
- The ![images/ref/buttons/bouton-panier5.png](./images/bouton-panier5.png) button removes an appointment selected in the customer panel;
- The ![images/ref/buttons/moins.png](./images/moins.png) button allows you to deselect appointments;
- The ![images/ref/buttons/bouton-prendre-rdv.png](./images/bouton-prendre-rdv_2.png) button allows you to make an appointment with the customer, and then be sent back to the [qualification of the appointment](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#creation-rdv-demande "Qualification of the appointment") page.
  If you click on this button in the header of the result table, you can access the [set appointment for several customers](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#prise-rdv-clients-multiple "Making appointments for several customers") function.
- The ![images/ref/buttons/bouton-carte.png](./images/bouton-carte.png) button displays the customer(s) on the map.

##### Making appointments for several customers

This function is only accessible from the [customer panel](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#panier-des-clients "Customers panel").

Making appointments for several customers

![images/ref/planification/prise-rdv-clients-multiple.png](./images/prise-rdv-clients-multiple.png)

A first section reminds you of the list of customers concerned.

The second part presents the same fields as the [qualification of the appointment](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#creation-rdv-demande "Qualification of the appointment").

- The Cancel button allows you to return to the customer panel;
- The Request appointments button creates appointments with a *Requested* [status](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/_the_different_statuses_for_appointments_in_opti_time.html#statuts "Statuses").

A [table](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-resultat "Search result") summarises the appointments created:

Result of the creation

![images/ref/planification/rdv-demandes-resultat.png](./images/rdv-demandes-resultat.png)

From this list, you can add the requested appointments to the [panel](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#manipuler-une-intervention-a-partir-du-panier "The panel") by clicking on the panel opposite an appointment or in the table header.

The Back button allows you to go back to the customer panel.

##### List of customers on alert

See the chapter on [List of customer alerts](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/_the_header_bar.html#liste-clients-urgent "List of customers on alert") in the header bar.
...
![images/ref/planification/gen-periodic.png](./images/gen-periodic.png)

The visit generation page contains the following fields:

- **Customers to select**

  - All recurring customers: all customers for whom the *recurring customer* check-box in the [customer form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-client-projet) is checked, will be selected.
  - Recurring customers in the panel only: only customers present in the [customer panel](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#panier-des-clients "Customers panel") and for whom the *regular customer* check-box in the [customer form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-client-projet) is checked will be selected.
- **Generation period to use**

  - By sales period: the generation will be applied to the selected [sales periods](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/donnees.html#periode-vente "Sales period").
...
The ![images/ref/buttons/play.png](./images/play.png) button allows you to run the generation of visits between the two dates.

The ![images/ref/buttons/bouton-retour.png](./images/bouton-retour.png) button takes you back to the previous page.
...
- [display customers](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#visualiser-clients "View customers")
- [on-call duty management](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#gestion-astreintes "On-call duty management")
- [equipment assignements](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#affectation-materiel "Equipment assignments")

##### Handling of temporary posts

This page allows the user to search, [create](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-creer "Create an object in the Planning module"), modify or [delete](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-supprimer "Delete an object in the Planning module") the [temporary posts](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#objets-postes-temp "Temporary posts") of resources.

Main page for managing temporary posts

![images/ref/planification/page-postes-temporaires.png](./images/page-postes-temporaires.png)

The principle of the search functions is described in the [Search in the Planning module](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-recherche "Search in the Planning module") chapter.

The search fields are described in the [temporary post form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-poste-temporaire "Temporary post form").

The ![images/ref/buttons/bouton-ajouter.png](./images/bouton-ajouter_4.png) button serves to add a new temporary post. It returns you to the [form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-poste-temporaire "Temporary post form") in creation mode.

##### Assignment of secondary worksites

This page allows you to search, [create](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html), modify or [delete](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html) the [secondary worksites](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#objets-sites-second "Secondary worksites") of resources.

The search page contains [search](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-recherche "Search in the Planning module") fields as well as a list of worksites that have already been saved.

The search fields are described in the [secondary worksite form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-site-second "Secondary worksite form").

Click on a line in the table to access the [secondary worksite form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-site-second "Secondary worksite form") in modification mode.

The ![images/ref/buttons/bouton-ajouter.png](./images/bouton-ajouter_5.png) button adds a new secondary site. It returns the [secondary worksite](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-site-second "Secondary worksite form") in creation mode.

##### View customers

This page allows you to see customers assigned to the resource selected in the drop-down list.

The search page contains [search](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-recherche "Search in the Planning module") fields as well as a list of on-call duties that have already been saved.

View customers

![images/ref/planification/interv-liste-client.png](./images/interv-liste-client.png)

##### On-call duty management

This page allows you to search, [create](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-creer "Create an object in the Planning module"), modify or [delete](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-supprimer "Delete an object in the Planning module") [on-call duty items](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#objets-astreinte "On-call duty") for resources.

The search page contains [search](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-recherche "Search in the Planning module") fields as well as a list of on-call duties that have already been saved.

The search fields are described in the [on-call duty form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-astreinte "On-call duty form").

Click on a line in the table to access the [on-call duty form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-astreinte "On-call duty form") in modification mode.

The ![images/ref/buttons/bouton-ajouter.png](./images/bouton-ajouter_6.png) button allows you to add a new on-call duty. It returns the user to the [on-call duty form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-astreinte "On-call duty form") in creation mode.

##### Equipment assignments

This page allows the user to search, [create](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-creer "Create an object in the Planning module"), edit or [delete](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-supprimer "Delete an object in the Planning module") an assignment between previously created [equipment](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/donnees.html#materiel "Equipment") and existing [resources](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/donnees.html#RH "Human resource").

The search page contains [search](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#recherche-generique-filtre "Search filters") fields and a list of pre-saved assignments.
...
![images/ref/planification/secteur-ferme.png](./images/secteur-ferme.png)

The first part allows you to [refine the search](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#recherche-generique-filtre "Search filters") on sectors by selecting the dates along with a sector.
...
To define an opening / closing timeslot you can click on the ![images/ref/buttons/ca-ca.png](./images/ca-ca.png) button.  
It is then possible to define an opening / closing period:

Closing dates

![images/ref/planification/secteur-ferme-dates.png](./images/secteur-ferme-dates.png)

Finally, two tables at the bottom of the page display the number of appointments and resources for the sector selected in
the list of sectors.
...
This page serves to search for one or several [appointments](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#objets-rdv "Appointments") as a function of known data on these appointments.

|  |  |
| --- | --- |
| [Tip] | Tip |
| Only appointments in the same [area](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#changer-region "Change area") as the one selected will be displayed. |
...
![images/ref/planification/formulaire-de-recherche-d-un-rendez-vous.png](./images/formulaire-de-recherche-d-un-rendez-vous.png)

The principle of the search functions is described in the [Search in the Planning module](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-recherche "Search in the Planning module") chapter.

Search fields can be customised in the [Application Configuration](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/perso.html#config-appli "Application settings"), and are described in the [appointment form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-rdv "Appointment form").

**Result of the search**

Table of results

![images/ref/planification/resultat-de-la-recherche.png](./images/resultat-de-la-recherche.png)
...
The presence of buttons on each line in the table serves to apply certain actions without having to enter in the appointment
form. Here are a few of the possible actions:

- The ![images/ref/buttons/bouton-add2.png](./images/bouton-add2.png) button serves to add the appointment to the [list of selected appointments](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#lister-rdv-select "List selected appointments");
- The ![images/ref/buttons/bouton-localise-client-fiche.png](./images/bouton-localise-client-fiche_2.png) button serves to locate the appointment in the [map](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-carte.html "Map");
- The ![images/ref/buttons/bouton-panier.png](./images/bouton-panier.png) button will add this intervention to the [panel](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#manipuler-une-intervention-a-partir-du-panier "The panel").
...
This function displays all appointments selected in the lists of appointments via the ![images/ref/buttons/bouton-add2.png](./images/bouton-add2_2.png) button.

The [table of results](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-resultat "Search result") has [buttons common to appointment lists](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#boutons-liste-rdv).

List of selected appointments

![images/ref/planification/liste-rdv-sel.png](./images/liste-rdv-sel.png)

This list also has two buttons located top right:

- ![images/ref/buttons/bouton-panier5.png](./images/bouton-panier5_2.png) that lets you add all the appointments in the [panel](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#manipuler-une-intervention-a-partir-du-panier "The panel") to the selection.
- ![images/ref/buttons/bouton-panier4.png](./images/bouton-panier4_2.png) that lets you add all selected apppointments to the [panel](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#manipuler-une-intervention-a-partir-du-panier "The panel").

#### Search for appointments (requested, planned, reserved, confirmed, unplanned, subcontracted)

Depending on the [rights](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/utilisateurs.html#coll-droits "Collection of rights") granted to the user, they can access predefined searches, or filtered searches on appointment status.

For example, the Search on requested appointments link serves to search for appointments with a *Requested* [status](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/_the_different_statuses_for_appointments_in_opti_time.html#statuts "Statuses").

Each of the links opens a first screen that suggests filtering on date, on resource (or subcontractor), on worksite and on
intervention type.

Search on status

![images/ref/planification/formulaire-recherche-rdv-par-statut.png](./images/formulaire-recherche-rdv-par-statut.png)

The principle of the search functions is described in the [Search in the Planning module](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-recherche "Search in the Planning module") chapter.

The Search button returns you to the [list of results](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-resultat "Search result").  
Clicking on one of the appointments found in the list opens the [appointment form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-rdv "Appointment form").
...
| --- | --- |
| [Warning] | Warning |
| To access a predefined search, you need to have the corresponding [right](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/utilisateurs.html#coll-droits "Collection of rights") given by the Opti-Time administrator. |

This menu lets you access configured searches in the [Configuring the application](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/perso.html#config-appli "Application settings") menu of the Administration module.  
Rapid access links to these predefined queries can also be displayed in the [information pane](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-cadre-info.html "The information pane").
...
| --- | --- |
| [Warning] | Warning |
| To access this menu, you need to have the corresponding [right](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/utilisateurs.html#coll-droits "Collection of rights") given by the Opti-Time administrator (**CALLCENTER\_SEARCH\_CHAIN\_CONSTRAINT**). |

This function lets you search for appointments associated to [chaining constraints](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#contrainte-chainage "Setting up liaisons between appointments").
...
Click on a result line to open the form for this chaining constraint. It will then be possible to edit as required to add
or delete an appointment, or apply any other additional action, for example change the appointment status or edit selected
appointment dates.

#### Appointment alerts

This function returns you to the [appointment counters](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-cadre-info.html#compteurs-rdv "Appointment counters") function.

#### Customer gap

This function is used to [search](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-recherche "Search in the Planning module") for [appointments](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#objets-rdv "Appointments") for which the recurrence of customers constraint defined in the [customer form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-client-projet) is not respected.

The result is given in the form of a list of appointments, the fields of which are defined in the [appointment section](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-rdv "Appointment form").
...
The search options are described in the [Search](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#recherche-generique-filtre "Search filters") chapter.
...
This menu provides access to application alert messages subscribed to in the [@menu(Administration)](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/utilisateurs.html#abo "Subscription to alerts") module: these constitute the journal of technical exchanges and modifications made in the background to the application,
like, for example:
...
![images/ref/planification/alertes-applicatives.png](./images/alertes-applicatives.png)

The principle of the search functions is described in the [Search in the Planning module](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-recherche "Search in the Planning module") chapter.

#### Messaging service

This menu provides access to a full messaging service for the purpose of consulting, writing, sending or deleting messages
exchanged between users.  
The user can refresh this list at any time by clicking on the ![images/ref/buttons/recharger.png](./images/recharger.png) button located at the top right of the information pane.

This messaging manager displays messages in table form showing their status: unread, received, sent or all these (*read*, *answered*, *sent*, *draft*). Each column can be sorted.  
When you click on a line, the details of the corresponding message appear (sender, recipient, issue date, publication start
and end dates, message body text).  
...
- the recipient(s) selecting from the [resources](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/donnees.html#RH "Human resource") and [teams](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/donnees.html#equipe "Team") for the current area (or from one or several available if the area favourites are enabled),
...
This page modifies the characteristics of a past appointment, and notably declares that it has been fulfilled and under what
conditions.
...
![images/ref/planification/modifier-les-rendez-vous-du-passe.png](./images/modifier-les-rendez-vous-du-passe.png)

The application searches for, and lists the appointments likely to be modified.

![images/ref/planification/modifier-les-rendez-vous-du-passe-1.png](./images/modifier-les-rendez-vous-du-passe-1.png)

For each appointment, certain characteristics are given as reference, for example, the address, the date, the status and the
time window.
A drop-down menu proposes to modify the default value **Do nothing**:
...
+
It is possible to add several time windows clicking on the ![images/ref/buttons/bouton-add.png](./images/bouton-add.png) button.

+
The ![images/ref/buttons/bouton-delete.png](./images/bouton-delete.png) button deletes the time windows.

+
Click on the ![images/ref/buttons/bouton-prendre-rdv.png](./images/bouton-prendre-rdv_3.png) button having first made any modifications required.
You can then cancel all the modifications applied by clicking on the ![images/ref/buttons/bouton-invalider-creneau.png](./images/bouton-invalider-creneau.png) button.

- **Reactivate** enables the appointment to return to *Requested* status.
- **Fulfilled** serves to signal that the appointment has been fulfilled and to fill in any additional information relating to the fulfilment
  of the appointment (income generated, status of the task in hand, Follow-up required, and different comment lines that can
  be filled in).
- **Unplan** allows you to exit from the appointment in the planning.

##### Adding an appointment to a past planning

An appointment can be added to a past planning of a resource. For example, an appointment planned for the next day may have
been fulfilled ahead of time (an emergency, a timeslot liberated unexpectedly, etc).

Click on the "Choose" drop-down menu at the bottom of the window and select "Add an appointment".

A window proposes to search on requested, planned and confirmed appointments.
It will be possible to define a certain number of criteria to recover the appointment(s) that must be added to the planning.
Once the form has been filled, click on Search to run the search.

Search on appointments likely to be added to a past planning.

![images/ref/planification/modif-rdv-passe-ajouter-rdv.png](./images/modif-rdv-passe-ajouter-rdv.png)

The application proposes to list the appointments found, and you then just have to click on the appointment to add to the
past planning.

Before the final validation of the addition of this appointment, the operator must indicate the time window for the intervention
at the customer’s premises.
They must also supply details of the start and end time of the appointment, and if appropriate, the actual duration.

#### Display agendas

This function reinitialises the [planning](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html "The planning").

#### Handling unavailabilities

This page serves to [add](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-creer "Create an object in the Planning module") or [delete](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-supprimer "Delete an object in the Planning module") [unavailabilities](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#centre-d-appel-indisponibilite "Unavailabilities") to plannings managed by the user. It will be possible to create unavailabilities for one or several resources simultaneously
(handling of meetings) to supply details of appointment times, predefined or free, a recurrence, to overwrite an address,
or add a commentary etc.

This page is described in the [Unavailability form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-indispo "Unavailability form") chapter.

#### Unavailability search

This page allows you to search, [create](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-creer "Create an object in the Planning module"), modify or [delete](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-supprimer "Delete an object in the Planning module") [unavailabilities](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#centre-d-appel-indisponibilite "Unavailabilities").

Unavailability search

![images/ref/planification/recherche-indispo.png](./images/recherche-indispo.png)

The search page contains [search](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-recherche "Search in the Planning module") fields. Clicking on Search, the [list](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-resultat "Search result") of unavailabilities displays.

The search fields are described in the [unavailabilities](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-indispo "Unavailability form") form.

Click on a line in the search result to access the [reduced unavailability form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-reduite-indispo "Repeated unavailability form").
...
This function displays and describes the different appointments and scheduled interventions for a chosen duration (day/week)
for a connected resource/team.

Roadbook

![images/ref/portail/feuille-route.png](./images/feuille-route.png)
...
For each event in the day an access plan is provided by clicking on the ![images/ref/buttons/bouton-corriger-adresse.png](./images/bouton-corriger-adresse.png) button.  
Opening the access plan opens a floating window showing the map centered on the event, shown as a circular symbol indicating
the appointment time.  
This window can be resized on the screen, so it can be enlarged or reduced to match the space reserved for the map. Certain
graphical manipulations are possible via the utilisation of the vertical bar, at the top left of the window:
...
![images/ref/portail/export-feuille-route.png](./images/export-feuille-route.png)
...
You can also generate a file in Garmin, TomTom, HTML or xml format in order to be able to read the roadbook in a GPS navigation
application.
...
This menu serves to search, [create](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-creer "Create an object in the Planning module") and [delete](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-supprimer "Delete an object in the Planning module") [exceptional locations](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#localisations-exceptionnelles "Exceptional locations").

Search for exceptional locations

![images/ref/planification/page-localisation-exceptionnelle.png](./images/page-localisation-exceptionnelle.png)

The principle of the search functions is described in the [Search in the Planning module](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-recherche "Search in the Planning module") chapter.

The search fields are described in the [exceptional location form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-loc-exceptionnelle "Exceptional location form").

The ![images/ref/buttons/bouton-suggerer-localisation-exceptionnelle.png](./images/bouton-suggerer-localisation-exceptionnelle.png) button runs an analysis of the panel of appointments to plan, and suggests exceptional locations to fulfil distant appointments.

Clicking on a line in the result list returns you to the [exceptional location form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-loc-exceptionnelle "Exceptional location form").

The Forced mode check-box makes it possible to ignore journey times when deleting an exceptional location.

The Confirm/Unconfirm button allows you to change the status of the selected exceptional locations from *confirmed* to *to confirm* and vice versa.

|  |  |
| --- | --- |
| [Tip] | Tip |
| Unconfirmed exceptional locations can be modified during a [batch optimisation](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/optimisation.html#planif-optim "Optimisation planning"). |

#### Hotel locations

This page allows you to search, [create](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-creer "Create an object in the Planning module") and [delete](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-supprimer "Delete an object in the Planning module") [hotels](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#objets-hotel "Hotel locations").

Search screen for hotel locations

![images/ref/planification/hotel-rechercher.png](./images/hotel-rechercher.png)

The principle of the search functions is described in the [Search in the Planning module](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-recherche "Search in the Planning module") chapter.

The **Close to** field allows you to filter on towns including presaved hotels.

The search fields are described in the [hotel location form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-hotel "Hotel location form").

Clicking on a line in the result table returns you to the [hotel location form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-hotel "Hotel location form").

#### Locked day

This page allows you to search and [create](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-creer "Create an object in the Planning module") [locked days](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#objets-journees-verr "Locked days in the agenda") in resources' agendas.

Search screen for locked days

![images/ref/planification/page-date-controlee.png](./images/page-date-controlee.png)

The principle of the search functions is described in the [Search in the Planning module](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-recherche "Search in the Planning module") chapter.

The search fields are [configurable](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/perso.html#config-appli "Application settings"), they are described in the [locked day form in the agenda](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-journee-verrouillee "Locked day in the agenda").
...
Clicking on a line in the result table displays the corresponding [locked day form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-journee-verrouillee "Locked day in the agenda").

The ![images/ref/buttons/bouton-ajouter.png](./images/bouton-ajouter_7.png) button serves to create a new locked day for the resource selected in the drop-down list. This button opens the [locked day form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-journee-verrouillee "Locked day in the agenda") in edit mode.

#### Manage agenda markers

This page serves to search, [create](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-creer "Create an object in the Planning module"), modify or [delete](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-supprimer "Delete an object in the Planning module") [agenda markers](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#objets-jalons "Agenda markers").

Agenda marker search screen

![images/ref/planification/jalons-recherche.png](./images/jalons-recherche.png)

The principle of the search functions is described in the [Search in the Planning module](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-recherche "Search in the Planning module") chapter.

The search fields described in the [agenda marker form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-jalon "Agenda marker form").

Clicking on a line in the result table returns you to the [agenda marker form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-jalon "Agenda marker form").

The ![images/ref/buttons/bouton-ajouter.png](./images/bouton-ajouter_8.png) button allows you to create an agenda marker for the resource selected in the drop-down list. This button opens the [agenda marker form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-jalon "Agenda marker form") in edit mode.

#### Vehicles tracking

This function allows you, for a given worksite, to list and map the last known position of [vehicles](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/mob.html#mob-vehicules "Vehicles") with an on-board [tracking device](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/mob.html#mob-equip-suivi "Tracking device") [assigned](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/mob.html#mob-affectation "Assignments") to a resource for a given period.

Vehicle tracking screen

![images/ref/planification/suivi-vehicule.png](./images/suivi-vehicule.png)

This assumes that the application has been configured so it is associated to a [positions server](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/mob.html#mob-parametres "Settings").
...
![images/ref/planification/calc-iti.png](./images/calc-iti.png)

In the **Start** section, you will need to enter the start [address](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/intro-geocodage.html "The geocoding").

In the **Arrival** section, enter the arrival [address](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/intro-geocodage.html "The geocoding").

Next, it is possible to choose either the **start time** or the **arrival time**, and a **vehicle profile** lets you choose from a variety of preconfigured vehicles (car, truck, light delivery vehicle, delivery truck, bus, emergency
vehicle, emergency truck, taxi, bicycle, pedestrian) with technical specificities (average speeds, access restrictions to
various types of road…) that will then be taken into account for the calculation.
...
![images/ref/planification/calc-iti-result.png](./images/calc-iti-result.png)

The ![images/ref/buttons/bouton-exporter-resultat.png](./images/bouton-exporter-resultat.png) Export button exports the results.

The ![images/ref/buttons/play.png](./images/play_2.png) Start button displays the journey on the map as a series of route steps.
...
This function allows you to calculate the coordinates of an address in Latitude/Longitude (that is, in terms of geographic
coordinates).

Convert latitude / longitude

![images/ref/planification/convert-lat-lon.png](./images/convert-lat-lon.png)

This page contains [address](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/intro-geocodage.html "The geocoding") fields.
...
![images/ref/planification/recherche-environ-1.png](./images/recherche-environ-1.png)

This page contains an [address](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/intro-geocodage.html "The geocoding") section.
...
The following [result list](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-resultat "Search result") then displays:

Search around

![images/ref/planification/recherche-environ-2.png](./images/recherche-environ-2.png)

If the search is applied to customers or appointments, the ![images/ref/buttons/bouton-add2.png](./images/bouton-add2_4.png) button allows you to add the customer to the [customer panel](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#panier-des-clients "Customers panel"), or the appointment to the [list of selected appointments](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#lister-rdv-select "List selected appointments"), respectively.

The ![images/ref/buttons/iti.png](./images/iti.png) button runs a [route calculation](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#calc-iti "Compute a route") between the address entered and the corresponding object.

Clicking on the name of the object returns you to the [form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#call-center-fiche-gral "Forms").
...
![images/ref/planification/traffic-vue.png](./images/traffic-vue.png)

The ![images/ref/buttons/ca-fleche.png](./images/ca-fleche.png) button displays the status of traffic corresponding to the view displayed in the [planning](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#selection-vues "Planning views").

The ![images/ref/buttons/bouton-legende.png](./images/bouton-legende.png) button displays the legend for the page:

Legend

![images/ref/planification/circulation-legende.png](./images/circulation-legende.png)

The ![images/ref/buttons/bouton-retour.png](./images/bouton-retour_2.png) button takes you back to the preceding traffic status.

The ![images/ref/buttons/recyclage.png](./images/recyclage.png) button refreshes the traffic status.

Clicking on a check-box in the traffic status displays the next appointment management page:

Manage traffic

![images/ref/planification/traffic-gerer.png](./images/traffic-gerer.png)

The first column represents the confirmed appointment graphically: the ![images/ref/planification/rdv-traffic.png](./images/rdv-traffic.png) image represents the position of the appointment in the planning. The appointment concerned is represented by the second
item in the image.
...
The **Recalculated departure** and **Recalculated arrival** fields give the departure and arrival times for the appointment following recalculation of the journey time while taking
the traffic into account.
...
Predefined exports will allow export in .csv format of data according to the fields predefined in the [application settings](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/perso.html#config-appli "Application settings").

Planning

![images/ref/planification/liste-exports-predef.png](./images/liste-exports-predef.png)
...
- The **type**
- The **worksite**
- The appointments [**status**](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/_the_different_statuses_for_appointments_in_opti_time.html#statuts "Statuses")
- The appointments [**progression step**](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/_the_different_statuses_for_appointments_in_opti_time.html#etats-avancement "Progression steps")
- The **date**
...
This function is identical to that of [predefined exports](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#liste-exports-predef "Predefined exports list") except that it is not based on the [application settings](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/perso.html#config-appli "Application settings"), but on the .sql files stored in the ad hoc directory on the server.

---

|  |  |  |
| --- | --- | --- |
| [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-cadre-info.html) | [Up](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/module-planification.html) | [Next](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html) |
...
![loading table of contents...](./images/loading_4.gif)
...
[Search Highlighter (On/Off)](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#)
