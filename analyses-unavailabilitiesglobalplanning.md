...
|                                                                                                                                 |                                                                                                                        |
| ------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| [Sidebar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/planing-glob-indispo.html) | [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/centre-gravite.html) |
...
Choose a team and the time window in terms of dates and click on the ![images/ref/buttons/bouton-exporter-resultat.png](<.gitbook/assets/bouton-exporter-resultat (1).png>) button to display the table.
...
![images/ref/supervision/planning-indispo.png](.gitbook/assets/planning-indispo.png)
