...
|  |  |
| --- | --- |
| [Sidebar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/config.html# "Hide TOC tree") | [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/TDB.html) | [Up](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/module-supervision.html) | [Next](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/intervention.html) |
...
![images/ref/supervision/tableau-de-bord-config.png](./images/tableau-de-bord-config.png)

Validate button will mean the selected parameters are taken into account. The next step is to select a type of statistical table to
apply the configuration established.
...
It is possible to filter the search results by type of resource. The type of resource will correspond to the type of post
...
![images/ref/supervision/tableau-de-bord-period.png](./images/tableau-de-bord-period.png)

Having selected the resources on which the supervisor wants to obtain information, five options enable filtering on the type
of timespan:
...
- Period (From the…to the): two zones are reserved for activation of a calendar and choice of a personalised period.
...
![images/ref/supervision/tableau-de-bord-activite.png](./images/tableau-de-bord-activite.png)

The **Ignore** check-box, when checked, renders the selection of an intervention type inactive.

The **Activity type** check-box (a type of activity is made up of several types of intervention) when checked allows you to select between the
different types of activities. You can select several types of activities at the same time using the CTRL and SHIFT keys.

The **Activity type** check-box (a type of activity is made up of several types of intervention) when checked allows you to select between the
different types of activities. You can select several types of activities at the same time using the CTRL and SHIFT keys.

The **status** is optional. Once the check-box has been checked, you can choose between interventions that are cancelled, confirmed, completed,
requested but unplanned, or unplanned. The **Display all** option will systematically display the status of the different information items depending on the type of intervention selected.
...
![images/ref/supervision/tableau-de-bord-autre.png](./images/tableau-de-bord-autre.png)

---

|  |  |  |
| --- | --- | --- |
| [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/TDB.html) | [Up](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/module-supervision.html) | [Next](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/intervention.html) |
|  | [Home](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/index.html) |  |

- [Contents](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/config.html#treeDiv)
- [Search](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/config.html#searchDiv)
...
[Search Highlighter (On/Off)](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/config.html#)
