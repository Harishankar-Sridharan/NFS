...
|                                                                                                                   |                                                                                                             |
| ----------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| [Sidebar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/config.html) | [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/TDB.html) |
...
![images/ref/supervision/tableau-de-bord-config.png](.gitbook/assets/tableau-de-bord-config.png)
...
![images/ref/supervision/tableau-de-bord-period.png](.gitbook/assets/tableau-de-bord-period.png)
...
![images/ref/supervision/tableau-de-bord-activite.png](.gitbook/assets/tableau-de-bord-activite.png)

The **Ignore** check-box, when checked, renders the selection of an intervention type inactive.

The **Activity type** check-box (a type of activity is made up of several types of intervention) when checked allows you to select between the different types of activities. You can select several types of activities at the same time using the CTRL and SHIFT keys.

The **Activity type** check-box (a type of activity is made up of several types of intervention) when checked allows you to select between the different types of activities. You can select several types of activities at the same time using the CTRL and SHIFT keys.

The **status** is optional. Once the check-box has been checked, you can choose between interventions that are cancelled, confirmed, completed, requested but unplanned, or unplanned. The **Display all** option will systematically display the status of the different information items depending on the type of intervention selected.
...
![images/ref/supervision/tableau-de-bord-autre.png](.gitbook/assets/tableau-de-bord-autre.png)
