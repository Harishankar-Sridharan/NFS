...
|                                                                                                                         |                                                                                                               |
| ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| [Sidebar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/rdv-quantite.html) | [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/dispo.html) |
...
![images/ref/supervision/quantite.png](.gitbook/assets/quantite.png)
...
The section labelled (2) informs the user about the resource on which the table is to be calculated. The period or the date are displayed, as well as the area.
...
* **Number of appointments taken**: this will consist of manually made and optimised appointments made by the chosen resource. The number displayed is completed by a percentage;
...
In terms of quality, four indicators are calculated concerning costs. This information only concerns optimised appointments (and not those taken manually). Each time an appointment is taken, a cost is calculated as a function of the different constraints (time, unavailabilities). An appointment therefore has a real cost, and a best cost:
