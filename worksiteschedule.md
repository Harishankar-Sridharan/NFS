...
|  |  |
| --- | --- |
| [Sidebar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/portail-site-trav.html# "Hide TOC tree") | [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/portail-plan-reg.html) | [Up](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/module-portail.html) | [Next](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/portail-multi-res.html) |

### Worksite schedule

This page displays the planning of one or several resources as a function of the worksite they are affiliated to. It is accessed
by clicking on the Worksite schedule button in the main menu.
Depending on the rights profile, the user connected only sees him or herself, their worksite, or all worksites.
...
![images/ref/portail/planning-site-travail.png](./images/planning-site-travail.png)

Click on ![images/ref/buttons/periode-precedente.png](./images/periode-precedente.png) to return to the preceding day, or click on ![images/ref/buttons/periode-suivante.png](./images/periode-suivante.png) to proceed to the next day.  
The Week Planner can be viewed by clicking on the Week tab:

Worksite Week Planning

![images/ref/portail/planning-site-travail-semaine.png](./images/planning-site-travail-semaine.png)

Then click on ![images/ref/buttons/periode-precedente.png](./images/periode-precedente_2.png) to return to the previous week or click on ![images/ref/buttons/periode-suivante.png](./images/periode-suivante_2.png) to go to the next week.  
The Week planning (day by day) can be viewed by clicking on the Detailed Week tab:

Detailed Worksite Week Planning

![images/ref/portail/planning-site-travail-semaine-detail.png](./images/planning-site-travail-semaine-detail.png)

Then click on ![images/ref/buttons/periode-precedente.png](./images/periode-precedente_3.png) to return to the previous week or click on ![images/ref/buttons/periode-suivante.png](./images/periode-suivante_3.png) to go to the following week.  
...
![images/ref/portail/planning-site-travail-charge.png](./images/planning-site-travail-charge.png)

Then click on ![images/ref/buttons/periode-precedente.png](./images/periode-precedente_4.png) to return to the previous week, or click on ![images/ref/buttons/periode-suivante.png](./images/periode-suivante_4.png) to see next week.
...
- Display plannings for resources affiliated to a different main worksite, but having the selected worksite as their secondary
  worksite;
- Display plannings for resources affiliated to a different main worksite, but having as their secondary worksite the one selected,
...
- a resource inside a pink frame indicates that the resource is not affiliated to the main worksite (this is selected in the
  interface). However, this site is assigned to the resource as the secondary worksite at which he/she may work.

Example of the Worksite Planning

![images/ref/portail/planning-site-travail-secondaire.png](./images/planning-site-travail-secondaire.png)

In the example above, resource ARBY Amar is not affiliated to the main work site of Narbonne. However, Narbonne is his secondary
worksite.
To distinguish this resource from the others, his name is framed in pink.

Also, this resource has fulfilled an appointment that is not linked to the Narbonne worksite.
To indicate that the appointment has been fulfilled outside the worksite, this is framed with a slightly thicker outline.
