...
|  |  |
| --- | --- |
| [Sidebar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/resume-semaine.html# "Hide TOC tree") | [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/resume-jour.html) | [Up](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/module-supervision.html) | [Next](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/dispo.html) |

### Control panel - Scheduling summary by week

#### Role

This page shows a summary table of statistics linked to travel on the part of resources [configured](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/config.html "Control panel - Configure") previously (kilometers travelled, journey time, number of visits fulfilled, visit time, unused working time, etc).

This is identical to the [daily plannings summary](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/resume-jour.html "Control panel - Scheduling summary by day"), but the statistics are aggregated by week and not by day.

#### Application

First, you need to define the search period on plannings. The table display can be [reconfigured](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/config.html "Control panel - Configure") by clicking on Configure.
...
![images/ref/supervision/resume-planning-sem.png](./images/resume-planning-sem.png)

Click on the ![images/ref/buttons/bouton-recherche.png](./images/bouton-recherche_2.png) button to run a search on plannings.  
Click on ![images/ref/buttons/bouton-exporter-resultat.png](./images/bouton-exporter-resultat_2.png) to export the data from the table in a text file.
...
- [Contents](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/resume-semaine.html#treeDiv)
- [Search](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/resume-semaine.html#searchDiv)
...
[Search Highlighter (On/Off)](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/resume-semaine.html#)
