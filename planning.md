...
|  |  |
| --- | --- |
| [Sidebar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/module-planification.html# "Hide TOC tree") | [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/portail-otm.html)  | [Next](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html) |

## Planning

The Planning module is an **Opti-Time** planning module designed for planning personnel or on-line advisors, personal assistants….
It can be used by resources working in the field as a visualisation tool.
It serves to:
...
Access the Planning module by clicking at the top left of the [site header](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/bandeau.html "The header bar").

Accessing the call centre

![images/ref/planification/menu.png](./images/menu.png)

The Planning module is made up of four parts:

1. [Menu](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html "Menu");
2. [Map](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-carte.html "Map");
3. [Planning](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html "The planning");
4. [Information display frame](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-cadre-info.html "The information pane").

The four panes making up the call centre

![images/ref/planification/presentation-centre-d-appels.png](./images/presentation-centre-d-appels.png)

The three frames correspond to the map, the planning and the information display, and can all be resized using the buttons
located at the top right of each frame ![images/ref/buttons/bouton-redimensionnement.png](./images/bouton-redimensionnement.png).

- ![images/ref/buttons/bouton-etendre-le-cadre-vers-le-bas.png](./images/bouton-etendre-le-cadre-vers-le-bas.png) allows you to stretch the frame downwards;
- ![images/ref/buttons/bouton-etendre-le-cadre-vers-le-haut.png](./images/bouton-etendre-le-cadre-vers-le-haut.png) allows you to stretch the frame upwards;
- ![images/ref/buttons/bouton-masquer-le-cadre.png](./images/bouton-masquer-le-cadre.png) allows you to hide the frame;
- ![images/ref/buttons/bouton-plein-ecran.png](./images/bouton-plein-ecran.png) allows you to display the frame in full screen mode.
