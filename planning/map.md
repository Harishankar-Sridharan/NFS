...
|                                                                                                                              |                                                                                                                         |
| ---------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| [Sidebar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-carte.html) | [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/_the_header_bar.html) |
...
![images/ref/planification/carte-route.png](../.gitbook/assets/carte-route.png)

### Navigation

Take up a position on the map, and the mouse cursor changes into a hand that can be used to move around the map. The user can also zoom-in or zoom-out in the map using the sliding cursor at the left-hand side of the map, or again, using the mouse wheel.

Finally, a scale at the bottom left-hand side of the frame enables the user to appreciate the orders of magnitude for the current map.
...
![images/ref/planification/configuration-carte.png](../.gitbook/assets/configuration-carte.png)
...
![images/ref/planification/tool-tip-carte-rdv.png](../.gitbook/assets/tool-tip-carte-rdv.png)
...
![images/ref/planification/tool-tip-carte-client.png](../.gitbook/assets/tool-tip-carte-client.png)
