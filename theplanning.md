...
[![ Documentation](./images/logo_geoconcept_11.png)](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/index.html)

# Opti-Time Reference Guide Planning

|  |  |
| --- | --- |
| [Sidebar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html# "Hide TOC tree") | [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html) | [Up](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/module-planification.html) | [Next](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/module-supervision.html) |
...
![images/ref/planification/planning.png](./images/planning.png)

It is composed of three sections:

1. A [selection bar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#selection-vues "Planning views") for the different views in the plannings;
2. A [navigation bar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#planning-navigation "Navigation bar"), made up of navigation and display buttons;
3. The [agenda](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#call-center-agenda-rdv "The agenda") part (composed of appointments, unavailabilities, etc.)
...
Click on the ![images/ref/buttons/type-poste-masquer.png](./images/type-poste-masquer.png) button to hide the plannings and resources occupying a single post.
Conversely, the ![images/ref/buttons/type-poste-afficher.png](./images/type-poste-afficher.png) button redisplays any plannings hidden previously.
...
![images/ref/planification/options-d-affichage-du-planning.png](./images/options-d-affichage-du-planning.png)

##### Agenda kind

Agenda kinds available

![images/ref/planification/nature-du-planning.png](./images/nature-du-planning.png)

The planning manager can visualise the planning of one or several resources as a function of several kinds:

- **Appointments**: enables visualisation of the planned interventions on the given period as a function of their status (Planned, Reserved,
  Confirmed, or Fulfilled);
...
![images/ref/planification/periode-du-planning.png](./images/periode-du-planning.png)

The planning manager can view the planning for one or several resources on 4 different periods (these periods are not all
available, as they depend on the kind displayed):
...
| --- | --- |
| [Warning] | Warning |
| All these availabilities can be modified in the [Administration](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/donnees.html "Company data") module. |
...
- **Multi-resources**: displays the planning of several resources, teams, work sites or areas (if no parameters have been set at the outset, the
  user is directed to a configuration page);
- **Vehicle**: displays the planning for a vehicle.

Depending on the hierarchical level selected, the user can then choose in the drop-down list the resource, the team, the worksite,
the area, or the vehicle for which they want to consult the planning.

Finally, a ![images/ref/buttons/bouton-informations.png](./images/bouton-informations_4.png) [tool-tip](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#info-bulle-tournee "Route info"), available only in "Resource" mode, displays information about a route.
...
![images/ref/planification/fiche-reduite-ressource.png](./images/fiche-reduite-ressource.png)
...
- the Routes tab displays the **travel times** and **kilometers travelled** by the resource.
  If you display a daily planning, the time and kilometers displayed concern the selected day.
  If it is a weekly planning, the time and kilometers displayed correspond to the total time and distance travelled
  for the week (idem for a monthly planning).
...
- the Vehicle tab displays the [**default vehicle used**](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/donnees.html#RH-vehicule "Vehicle tab"), the **vehicle** and the **equipment** [assigned](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/mob.html#mob-affectation "Assignments") to the resource as well as the **period of assignment**.

The ![images/ref/buttons/planning-journalier.png](./images/planning-journalier.png) button displays the daily planning for the resource.

The ![images/ref/buttons/planning-hebdomadaire.png](./images/planning-hebdomadaire.png) button displays the weekly planning for the resource.

The ![images/ref/buttons/planning-mensuel.png](./images/planning-mensuel.png) button displays the monthly planning for the resource.

The ![images/ref/buttons/map-monde.png](./images/map-monde.png) button displays the route.

The ![images/ref/buttons/bouton-panier3.png](./images/bouton-panier3.png) button puts all the appointments for the route in the [panel](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#manipuler-une-intervention-a-partir-du-panier "The panel").

The ![images/ref/buttons/bouton-add2.png](./images/bouton-add2_5.png) button allos you to [select](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#lister-rdv-select "List selected appointments") all the appointments in the route.

#### Navigation bar

In addition to the planning visualisation parameters, other tools enable navigation in the planning for the purpose of consulting
it.

Bar of viewing functions in the planning

![images/ref/planification/barre-navigation-planning.png](./images/barre-navigation-planning.png)

The buttons in this part of the planning are as follows (from left to right in the navigation bar):

- The [panel](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#manipuler-une-intervention-a-partir-du-panier "The panel") ![images/ref/buttons/bouton-panier2.png](./images/bouton-panier2.png);
- The buttons to change the date of the [agenda](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#agenda-navig "Navigating from one date to another") composed of two arrows and a date:
- The [arrows](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#agenda-navig-recent "Previous or next agenda") to return to the preceding, ![images/ref/buttons/bouton-precedent.png](./images/bouton-precedent.png) or next, ![images/ref/buttons/bouton-suivant.png](./images/bouton-suivant.png) agenda;
- The [switch agenda](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#agenda-bascule "Switching the agenda") ![images/ref/buttons/bouton-bascul-de-l-agenda.png](./images/bouton-bascul-de-l-agenda.png) button;
- The button to display the [position of the resource on the map](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#agenda-suivi "Display the location of the resource in the map") ![images/ref/buttons/afficher-la-position-de-l-intervenant.png](./images/afficher-la-position-de-l-intervenant.png);
- The display of the ![images/ref/buttons/bouton-carte.png](./images/bouton-carte_2.png) [routes on the map](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#agenda-tournees "Display on the map");
- The button to display the [legend](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#agenda-legende "Display the legend") ![images/ref/buttons/bouton-legende.png](./images/bouton-legende_2.png);
- The [map pin](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#agenda-punaise "Map pin") ![images/ref/buttons/bouton-punaise.png](./images/bouton-punaise.png).

##### The panel

If interventions are present in the panel, the number of interventions will be indicated by a symbol on the panel icon: ![images/ref/buttons/bouton-panier2.png](./images/bouton-panier2_2.png).

Clicking on this image, the user can visualise the interventions stored in the panel. They are stored by resource and with
the relevant identifier(s).

Interventions stored in the panel

![images/ref/planification/interventions-stockees-dans-le-panier.png](./images/interventions-stockees-dans-le-panier.png)
...
- if a clash is encountered (unavailability, intervention already planned or a constraint is not respected), the user is warned
  by a message that summarises the conflict encountered and the choice to force the placement of this intervention or not. The
  interventions in conflict will then be replanned.

Other options:

1. Moving the orange frame in the panel towards the resource’s planning, the application will try to replan all appointments
   in this planning. The number of replanned appointments will then be displayed.
2. When you move an appointment from the panel on to the name of the resource, the application chooses the best timeslot in
   which to position the appointment in the resource’s day.

##### Navigating from one date to another

To consult the planning for earlier or later periods, the user can click on the ![images/ref/buttons/bouton-simple-chevron-gauche.png](./images/bouton-simple-chevron-gauche_2.png) or ![images/ref/buttons/bouton-simple-chevron-droit.png](./images/bouton-simple-chevron-droit_2.png) buttons.
...
The user can rapidly move to find an agenda viewed recently using the ![images/ref/buttons/bouton-precedent.png](./images/bouton-precedent_2.png) button, and then return to the next agenda using the ![images/ref/buttons/bouton-suivant.png](./images/bouton-suivant_2.png) button.

These buttons navigate through plannings viewed previously in all their forms. For example, if the user has moved from a resource
view to a worksite view, they may return to the worksite view simply by clicking on ![images/ref/buttons/bouton-precedent.png](./images/bouton-precedent_3.png).
...
By default, the agenda is displayed horizontally with the name of the resource(s) on-line and the time, the day, the weeks
or the months in columns.

Clicking on the ![images/ref/buttons/bouton-bascul-de-l-agenda.png](./images/bouton-bascul-de-l-agenda_2.png) button, the agenda switches into vertical viewing mode.

Example of a vertical agenda

![images/ref/planification/agenda-bascule.png](./images/agenda-bascule.png)

A click on the ![images/ref/buttons/revenir-a-l-agenda-par-defaut.png](./images/revenir-a-l-agenda-par-defaut.png) button takes you back to the default agenda display.

##### Display the location of the resource in the map

This button displays the location of the resource on the map.

In addition to their map position, the user is informed if the position of the resource corresponds or not to the planned
itinerary.
...
| --- | --- |
| [Note] | Note |
| It is only available in [views](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#selection-vues "Planning views") the day or week. |

Visualising a route on the map

![images/ref/planification/affichage-d-une-tournee-sur-la-carte.png](./images/affichage-d-une-tournee-sur-la-carte.png)
...
![images/ref/planification/affichage-de-plusieurs-tournees.png](./images/affichage-de-plusieurs-tournees.png)
...
![images/ref/planification/legende-charge-planning.png](./images/legende-charge-planning.png)

The legend displays, by [object](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html "Objects in the Planning module") type, the colour of the various items in the planning.

The colours of objects displayed in the planning are [configurable](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/perso.html#couleurs "Colors").
...
When performing manipulations on the [information frame](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-cadre-info.html "The information pane") (search for an intervention, for example), the planning is updated automatically to display the agenda concerning the search
applied.
...
The items for this day are displayed in graphical form (either horizontally, or vertically) and a table, at the bottom of
the page, displays the detail for these items.

The colours of items in the planning are described in the [legend](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#agenda-legende "Display the legend").
...
The agenda appearance will vary depending on the [selected view](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#selection-vues "Planning views"):

Day agenda for the worksite

![images/ref/planification/agenda-jour-site.png](./images/agenda-jour-site.png)

Day agenda for the resource

![images/ref/planification/agenda-jour-itv.png](./images/agenda-jour-itv.png)

In this view, under the graphical representation of the agenda, a list provides details of all the items in the planning in
chronological order, indicating the start and end time, the intervention type, the status, the names of both the appointment
and the town in which it is to take place.

Monthly agenda for the resource in workload view

![images/ref/planification/agenda-charge-itv.png](./images/agenda-charge-itv.png)

The agenda provides access to functions according to the [user rights](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/utilisateurs.html#coll-droits "Collection of rights"):

- [reoptimise a day / week](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#reoptim "Reoptimising the day")
- [move or extend](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#deplacer-etirer "Move / extend objects") items (appointments, unavailabilities or exceptional locations)
- [manage appointments](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#tool-tip-rdv "Managing appointments in the agenda")
- [manage unavailabilities](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#tool-tip-indispo "Manage unavailabilities in the agenda")
- [manage non-worked hours for the resource](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#tool-tip-horaire "Manage non-worked hours in the agenda")
- [manage exceptional locations](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#tool-tip-loc-except "Manage exceptional locations in the agenda")
- [manage locked agendas](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#tool-tip-verr "Managing locked agendas")
- [manage temporary work posts](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#tool-tip-postes "Handling temporary posts in the agenda")
- [fill free timeslots in the agenda](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#tool-tip-planning-vide "Fill an empty agenda")
- [display information about journey times](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#tool-tip-trajet "Journey time infobox")
- [display information about lunch break](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#tool-tip-pause-dej "The lunch break infobox")
- edit the [roadbook](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#feuille-de-route "Editing the roadbook")
- display [information about the resource](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#info-bulle-tournee "Route info") by clicking on the ![images/ref/buttons/bouton-informations.png](./images/bouton-informations_5.png) button opposite the name of the resource

##### Reoptimising the day

The ![images/ref/buttons/reoptimiser-la-journee.png](./images/reoptimiser-la-journee.png) button runs a re-optimisation of the day on a technician directly from their planning. In the window that opens, the user
can define from what time the re-optimisation of the day must start, and whether the tool can insert interventions to be planned
or only retain those that have already been planned on that day.

Reoptimisation options on the day

![images/ref/planification/options-de-reoptimisation-de-la-journee.png](./images/options-de-reoptimisation-de-la-journee.png)
...
You can move or extend all objects in the planning ([appointments](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#objets-rdv "Appointments"), [unavailabilities](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#centre-d-appel-indisponibilite "Unavailabilities"), non-worked hours, [nights away](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#localisations-exceptionnelles "Exceptional locations"), [agenda marker](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#objets-jalons "Agenda markers")).
...
To extend an object, simply move the mouse to the extremity of the object, and then click and stretch it forward to shorten
it, or backwards to make it larger:

Put the mouse cursor at the object’s extremity:

![images/ref/planification/etirer-1.png](./images/etirer-1.png)

Stretch the object:

![images/ref/planification/etirer-2.png](./images/etirer-2.png)
...
![images/ref/planification/tool-tip-rdv.png](./images/tool-tip-rdv.png)

The tool-tip will contain some information from the [appointment](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-rdv "Appointment form") such as the customer name, and the intervention address or site.

A series of action buttons serve to apply the following operations to the intervention:

- Put the appointment in the [panel](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#manipuler-une-intervention-a-partir-du-panier "The panel") ![images/ref/buttons/bouton-panier3.png](./images/bouton-panier3_2.png);
- Add the appointment to the [list of selected appointments](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html) ![images/ref/buttons/bouton-add2.png](./images/bouton-add2_6.png);
- Reserve / Unconfirm: changes the appointment [status](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/_the_different_statuses_for_appointments_in_opti_time.html#statuts "Statuses") to *Reserved* / previous ![images/ref/buttons/deconfirmer.png](./images/deconfirmer.png);
- Unplan / Suspend an appointment: changes the appointment [status](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/_the_different_statuses_for_appointments_in_opti_time.html#statuts "Statuses") to previous / *Suspended* ![images/ref/buttons/ca-deplanifier.png](./images/ca-deplanifier.png);
- Reactivate: changes the appointment [status](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/_the_different_statuses_for_appointments_in_opti_time.html#statuts "Statuses") to *Requested* ![images/ref/buttons/reactiver.png](./images/reactiver.png);
- Delete: changes the appointment [status](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/_the_different_statuses_for_appointments_in_opti_time.html#statuts "Statuses") to *Abandonned* ![images/ref/buttons/bouton-supprimer-une-indisponibilite.png](./images/bouton-supprimer-une-indisponibilite.png);
- Cancels the appointment ![images/ref/buttons/pas-realise.png](./images/pas-realise.png);
- Displays the [appointment form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-rdv "Appointment form") ![images/ref/buttons/informations-depuis-l-infobulle.png](./images/informations-depuis-l-infobulle.png);
- Displays the [customer form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-client "Customer form") ![images/ref/buttons/tooltip-client.png](./images/tooltip-client.png).

|  |  |
| --- | --- |
| [Tip] | Tip |
| Clicking on an intervention in the planning, the [intervention form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-rdv "Appointment form") opens directly and displays in the [map](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-carte.html "Map"). |
...
![images/ref/planification/infobulle-d-une-indisponibilite.png](./images/infobulle-d-une-indisponibilite.png)

This displays information about the unavailability.

The ![images/ref/buttons/informations-depuis-l-infobulle.png](./images/informations-depuis-l-infobulle_2.png) button displays the [abbreviated unavailability form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-reduite-indispo "Repeated unavailability form").

The ![images/ref/buttons/bouton-supprimer-une-indisponibilite.png](./images/bouton-supprimer-une-indisponibilite_2.png) button deletes the unavailability. In the case of a repeated unavailability, a message will display to allow the user to
choose between deleting all repetitions or only the selected unavailabilities.

|  |  |
| --- | --- |
| [Tip] | Tip |
| Clicking on an unavailability in the planning, the [abbreviated form for the unavailability](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-reduite-indispo "Repeated unavailability form") opens directly and displays in the [map](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-carte.html "Map"). |

##### Manage non-worked hours in the agenda

Moving the mouse cursor over the non-worked hours of a resource (start or end of the day), an infobox appears showing the
different manipulations that are possible:

Infobox for a series of non-worked hours

![images/ref/planification/tool-tip-non-travaille.png](./images/tool-tip-non-travaille.png)

- The ![images/ref/buttons/ajout-nuitee.png](./images/ajout-nuitee.png) button returns you to the [managing nights away](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html) page.
- The ![images/ref/buttons/verrou.png](./images/verrou.png) / ![images/ref/buttons/deverrouiller.png](./images/deverrouiller.png) button allows you to [lock / unlock the day](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html).
- The ![images/ref/buttons/bouton-ajouter-une-indisponibilite-express.png](./images/bouton-ajouter-une-indisponibilite-express.png) button adds an [unavailability](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/donnees.html#RH-passage-depot "Stop points tab") in the agenda.

##### Manage exceptional locations in the agenda

Moving the mouse over an [exceptional location](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#localisations-exceptionnelles "Exceptional locations"), the corresponding infobox displays.

Here you will find certain information items from the [exceptional location form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-loc-exceptionnelle "Exceptional location form").

- The ![images/ref/buttons/informations-depuis-l-infobulle.png](./images/informations-depuis-l-infobulle_3.png) button displays the [exceptional location form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-loc-exceptionnelle "Exceptional location form");
- The ![images/ref/buttons/bouton-supprimer-une-indisponibilite.png](./images/bouton-supprimer-une-indisponibilite_3.png) button enables deletion of the exceptional location.

##### Managing locked agendas

Clicking on the lock of a locked day ![images/ref/planification/journee-verr.png](./images/journee-verr.png), displays the [locked day form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-journee-verrouillee "Locked day in the agenda").

##### Handling temporary posts in the agenda

In [posts view](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html#selection-vues "Planning views"), if you move the mouse over a non-worked timeslot, the posts infobox displays.

The ![images/ref/buttons/casque.png](./images/casque.png) button allows you to create a [temporary post](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#gestion-postes-temp "Handling of temporary posts").

On an existing post,

- The ![images/ref/buttons/informations-depuis-l-infobulle.png](./images/informations-depuis-l-infobulle_4.png) button displays the [temporary post form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-poste-temporaire "Temporary post form");
- The ![images/ref/buttons/bouton-supprimer-une-indisponibilite.png](./images/bouton-supprimer-une-indisponibilite_4.png) button deletes the temporary post.

##### Fill an empty agenda

Gliding the mouse cursor over the empty planning of a resource, an infobox or popup appears with the possibility of various
manipulations:

Infobox for an empty planning

![images/ref/planification/infobulle-d-un-planning-vide.png](./images/infobulle-d-un-planning-vide.png)
...
|  | In the infobox, the user clicks on the images/ref/buttons/bouton-remplir-le-planning.png button. By default, the application searches for all appointments with a [status](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/_the_different_statuses_for_appointments_in_opti_time.html#statuts "Statuses") of *Requested* or *Suspended* that can be added to the planning.  |  |  | | --- | --- | | [Tip] | Tip | | If the [application configuration](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/perso.html#config-appli "Application settings") allows this (Optimization tab > Fill planning > agenda.filling > *searchPlanned* set to TRUE), it will also be possible to take appointments with a [status](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/_the_different_statuses_for_appointments_in_opti_time.html#statuts "Statuses") of *Planned* into account. |  The system applies its search as a function of the resource’s overall route plan. A list of interventions is automatically suggested in the left-hand window.  images/ref/planification/remplir_planning_1.png  This list is sorted in order of cost suitability (best compromise between the date, the resource’s qualification and the journey distance to arrive at the appointment). The lower the cost of the route plan suggestion, the higher its suitability, and the better the suggestion.  |  |  | | --- | --- | | [Tip] | Tip | | A stars system can be configured to represent this suitability visually. To do this, activate the [optimization setting](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/optimisation.html#param-optim "Optimisation parameters") *Display solution cost as a chart*. |  Click on the images/ref/buttons/bouton-carte.png icon to view the appointment on the map.  Click on an appointment and then on the Confirm button to add the latter to the planning.  The Expand the search button forces the application to analyze more towns and cities and other plannable appointments to bring the cost down.  Check the Display analyzed cities to list towns and cities located near to the resource’s itinerary in the form of a table with four columns.  images/ref/planification/remplir_planning_2.png  For a given town, the **Added time** corresponds to the journey time added to the itinerary if the resource arrives at an appointment from this town, and the **Total distance** corresponds to the number of kilometers added to arrive at this appointment.  When you click on the images/ref/buttons/bouton-localiser.png icon, the map centres on the town being analyzed.  Check the Display analyzed appointments box to list all appointments located near to the resource’s planned route.  images/ref/planification/remplir_planning_3.png |
| **2.** | **Adding an appointment** |
|  | Clicking on the images/ref/buttons/ajouter-une-intervention.png button, this option plans an intervention that does not yet exist in the interventions to be planned. This displays the customer’s [information form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#prendre-nouveau-rdv "Making a new appointment"). |
| **3.** | **Make an appointment for an existing customer** |
|  | When you click on the images/ref/buttons/tooltip-client.png button, this option allows you to schedule an intervention for an existing customer. The customer [search function](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-menu.html#rechercher-type-client "Search on a customer type") then displays. |
| **4.** | **Adding an unavailability** |
|  | Click on the images/ref/buttons/bouton-ajouter-une-indisponibilite.png button to display the [unavailability form](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#fiche-indispo "Unavailability form"). |
| **5.** | **Creating an express unavailability** |
|  | This option is available using the images/ref/buttons/bouton-ajouter-une-indisponibilite-express.png button in the infobox. It will only be useable if an [express unavailability](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/donnees.html#RH-passage-depot "Stop points tab") has been configured beforehand for the resource. The express unavailability is then automatically placed in the resource’s planning. |
| **6.** | **Add a locked day** |
...
| **7.** | **Add marker** |
|  | By clicking on the images/ref/buttons/jalon.png button, this option lets you [add a marker](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-objets.html#objets-jalons "Agenda markers"). |

##### Journey time infobox

Moving the mouse cursor over the journey time between two appointments, for example, an infobox displays the number of kilometers
and the journey time.

Any journeys that are not connected with the appointment (for example, the return journey between a night away and the usual
return address) can also be displayed in the agenda if the [application configuration](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/perso.html#config-appli "Application settings") allows this (Display tab > Calendar > planning.content > *completeWithMoves*). Their duration can be limited in order to force splitting of the appointment, using the *moveMaxDisplayedDuration* parameter.
...
The ![images/ref/buttons/verrou.png](./images/verrou_3.png) / ![images/ref/buttons/deverrouiller.png](./images/deverrouiller_3.png) button allows you to [lock / unlock the day](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/call-center-agenda.html).
...
![loading table of contents...](./images/loading_11.gif)
