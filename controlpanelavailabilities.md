...
|                                                                                                                  |                                                                                                                        |
| ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| [Sidebar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/dispo.html) | [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/resume-semaine.html) |

## Control panel - Availabilities

### Role

This page proposes a summary table of the different unavailabilities [configured](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/config.html) previously.
...
![images/ref/supervision/dispos.png](.gitbook/assets/dispos.png)
...
Section (2) summarises all the parameters specified in the [configuration](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/config.html) step concerning unavailabilities. Three parameters are displayed: the name of the resource (or team or worksite), their reference area and today’s date.\
The table of availabilities is only suggested for today’s date.

The table (3) provides, in the right-hand part of the screen, all the resources chosen during the configuration process. Two types of information are available: the number of programmed visits, and the number of programmed hours. The latter break down into visits, worked and non-worked unavailabilities, journey times and free times.\
The calculated time is displayed in hours and minutes. Each information item is calculated for each of the days in the current week. The total number of programmed hours for each day evidently does not take into account any free time.
