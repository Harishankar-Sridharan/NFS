...
|  |  |
| --- | --- |
| [Sidebar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/portail-multi-res.html# "Hide TOC tree") | [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/portail-site-trav.html) | [Up](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/module-portail.html) | [Next](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/indisponibilite.html) |

### Multi-Resource schedule

This page displays the planning(s) for one or several resources that are not affiliated to the team of the resource connected
to the application.
This function can be accessed by clicking on the Multi-resource schedule in the main menu.

The page suggests displaying the plannings of one or several resources by filtering on 7 criteria:
**resource type**, **areas of team affiliation**, **teams**, **areas of worksite affiliation**, **worksite**, **period** (day planning or week planning) and the **date**.

Filter window for displaying the plannings of one or several resources affiliated to another team

![images/ref/portail/planning-multi-ressource.png](./images/planning-multi-ressource.png)

Choose, in the **Resource type** list, the type of role held by the resource sought.
Select the **All** item to perform the search on all resource types.

Choose, in the **Areas of teams** list, the area to which the team of the resource(s) sought is affiliated.
Select **All** to perform the search on all the areas to which the teams are affiliated.

Choose, in the **Teams** listing, the team to which the resource(s) is or are affiliated.
Select the **All** item to perform the search on all teams.

Choose, in the listing of the **Areas of affiliation of worksites**, the area of affiliation for the worksite of the resource(s) sought.
Select the **All** item to perform the search on all areas of worksites.

Choose, in the **Worksite** listing, the site of affiliation for the resource(s) sought.
Select **All** to perform the search on all worksites.
...
![images/ref/portail/planning-multi-ressource-filtre.png](./images/planning-multi-ressource-filtre.png)
