...
|  |  |
| --- | --- |
| [Sidebar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/supervision-accueil.html# "Hide TOC tree") | [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/module-supervision.html) | [Up](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/module-supervision.html) | [Next](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/journal.html) |

### Home page

Opti-Time’s supervisor module is accessed by clicking on the Supervisor tab in the blue toolbar at the top of the screen, or directly by entering the application if the [user profile](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/donnees.html#RH-utilisateur "User tab") is configured to open Opti-Time on this module.

|  |  |
| --- | --- |
| [Note] | Note |
| You will need to be connected using a profile that has access to the supervisor role (see the chapter [Users](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/utilisateurs.html "User handling")). |

Supervisor home page:

![images/ref/supervision/accueil-superviseur.png](./images/accueil-superviseur.png)
...
- The [Control panel](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/TDB.html "Control panel") section: this section displays statistical summaries concerning appointments and unavailabilities, enabling tracking and
  steering of the mobile work force’s activities.
- The [Analyses](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/distancier.html "Analyses - Customer distance matrix") section: this section generates reports and indicators on appointments completed, and on the sectorisation performed.

|  |  |
| --- | --- |
| [Tip] | Tip |
| The reports contained in the "Control panel" section must be [configured](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/config.html "Control panel - Configure") beforehand. |

The menu contains the following items:

- [**Supervisor home page**](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/supervision-accueil.html "Home page")
- [**Journal**](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/journal.html "Journal")
- **Control panel**

  - [Configure](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/config.html "Control panel - Configure")
  - [Interventions](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/intervention.html "control panel - Interventions")
  - [Scheduling summary by day](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/resume-jour.html "Control panel - Scheduling summary by day")
  - [Scheduling summary by week](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/resume-semaine.html "Control panel - Scheduling summary by week")
  - [Availabilities](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/dispo.html "Control panel - Availabilities")
  - [Appointment taking Quantity](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/rdv-quantite.html "Control panel - Appointment taking quantity")
  - [Appointment taking Quality](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/rdv-qualite.html "Control panel - Appointment taking quality")
  - [Targets](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/objectif.html "Control panel - Targets")
- **Analyses**

  - [Customer distance matrix](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/distancier.html "Analyses - Customer distance matrix")
  ...
  - [Scheduling compliance](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/conformite.html "Analyses - Scheduling compliance")
  - [Overtimes](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/heures-sup.html "Analyses - Overtimes")
