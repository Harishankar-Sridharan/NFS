# Guided Help - Opti-Time Reference Guide
...
|                                                                                                               |                                                                                                                          |
| ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| [Sidebar](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/WM.html) | [Prev](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/intro-geocodage.html)  |

### Guided Help

**Opti-Time** guided help is based on _WalkMe_ technology and is accessible only if the [corresponding right](https://mynomadia.com/privatedoc/9LLcWh7j74sENa54/optitime-doc/docs/en/otgs-reference-book/utilisateurs.html#coll-droits) (Doc tab > Perimeter > **DOC\_ENABLE\_WALKME** right) is associated to the user profile.

In the same way as a GPS, this Digital Adoption Platform (DAP) offers different menus to guide users step-by-step, with specific advice they may need, and updates about the latest functional changes in the application.

To do this, open the help pane superposed transparently in the interface and click on the guide rquired.

![images/ref/intro/walkme.png](.gitbook/assets/walkme.png)
